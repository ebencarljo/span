<?php
class span_comments_widget extends WP_Widget {

	public function __construct() {
		$widget_ops = array( 
			'classname' 	=> 'widget-popular-posts wordpress-comments', 
			'description' 	=> __( 'Your site&#8217;s most recent comments.' ) 
		);
		parent::__construct('recent-comments', __( 'Span Recent Comments' , 'span' ), $widget_ops);
...
<?php
	...
	public function widget( $args, $instance ) {
		...
		$output .= '<ul id="recentcomments" class="posts-list">';
		if ( $comments ) {
            ...
            <li>
               ...
               <div class="widget-content">
                  <p> 
                  	...
                  	<a style="text-transform:inherit;" href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ) ;?>"><?php echo $comment_content; ;?></a>
                     <a style="text-transform:inherit;" href="<?php echo esc_url( $comment->guid );?>"><?php echo sprintf( __( 'on: "%s"' , 'span' ), get_the_title( $comment->comment_post_ID ) ) ;?></a>
						</p>
