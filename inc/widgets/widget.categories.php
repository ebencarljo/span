<?php
class span_categories_widget extends WP_Widget {

	public function __construct() {
		$widget_ops = array( 'classname' => 'categories', 'description' => __( "A list or dropdown of categories." ) );
		parent::__construct('devor_categories', __( 'Span Posts Categories' , 'devor' ), $widget_ops);
	}
...
<?php
		...
		$categories 	= 	preg_replace('/<\/a> \(([0-9]+)\)/', ' </a> <span class="num-posts">\\1</span>', $categories);
		echo $categories;
?>
		</ul>
<?php
