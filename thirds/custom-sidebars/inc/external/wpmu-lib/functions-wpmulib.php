...
class TheLib_1_0_17 {
	...
	protected function _css_url( $file ) {
		...
		if ( null === $Url ) {
			$Url = get_template_directory_uri() . '/thirds/custom-sidebars/inc/external/wpmu-lib/css/';
		}
		return $Url . $file;
	}
	...
	protected function _js_url( $file ) {
		...
		if ( null === $Url ) {
			$Url = get_template_directory_uri() . '/thirds/custom-sidebars/inc/external/wpmu-lib/js/';
		}
		return $Url . $file;
	}
