...
add_action(
	'after_setup_theme', // plugins_loaded
...
function inc_sidebars_free_init() {
	...
	define( 'CSB_LANG', 'span' ); // span handle that now.

	$plugin_dir = dirname( __FILE__ );
	$plugin_dir_rel = wp_get_theme();
	$plugin_url = get_template_directory_uri() . '/thirds/custom-sidebars/';

	// var_dump( $plugin_url );die;
	define( 'CSB_PLUGIN', __FILE__ );
	define( 'CSB_LANG_DIR', get_template_directory() . '/lang/' );
